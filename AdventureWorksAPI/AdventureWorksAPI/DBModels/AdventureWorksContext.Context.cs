...
namespace AdventureWorksAPI.DBModels
{
    ...
    public partial class AdventureWorks2014Entities1 : DbContext
    {
        ...
        [EdmFunction("AdventureWorks2014Entities1", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2014Entities1].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
